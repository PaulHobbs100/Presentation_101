;
; nasm -f elf64 -o hello_1e1.o hello_1e1.asm &&  ld -o hello_1e1 hello_1e1.o && split hello_1e1
;
...
section .text                   ;Text section (code)
    _start:
        ...
        mov rdi, 1        
        mov rsi, msg      
        mov rdx, 31             ;Length of string (msg)   
...
section .data                   ;Data section
    msg: db "Hi Honey Badgers!",10,"and Wombats.",10